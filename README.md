...
| Table | Description |
|---|---|
| fact_order_items | One row per item in an order, with price, shipping cost, and order status ([X] rows) |
...
Olist generated ~R$[13.5]M in revenue across [X] orders from [X] unique customers. Revenue grew steadily throughout 2017, rising roughly six-fold from January to December, with a peak in November driven by Black Friday. Sales are heavily concentrated in São Paulo, which also has our lowest average shipping cost. Customers in remote northern states pay nearly three times as much for shipping, which may be limiting our growth in those regions.
...
- **Marketing:** Build inventory plans and campaigns around Black Friday, our biggest sales month of the year.
- **Category management:** Prioritize promotions and seller recruitment in our five above-average categories.
- **Logistics:** Test ways to lower shipping costs in the north and northeast, such as shipping discounts, regional warehouses, or recruiting local sellers, to grow sales in underserved states.
- **Next steps for analysis:** Review delivery times, customer review scores, and repeat purchase rates to see whether slow or expensive shipping affects customer satisfaction.
